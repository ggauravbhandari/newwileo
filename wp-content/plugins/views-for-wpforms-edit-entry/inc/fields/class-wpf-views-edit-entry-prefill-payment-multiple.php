<?php
class WPF_Views_Edit_Entry_Prefill_Payment_Multiple extends WPF_Views_Edit_Entry_Prefill_Fields {

	public $field_type = 'payment-multiple' ;
...
new WPF_Views_Edit_Entry_Prefill_Payment_Multiple();
