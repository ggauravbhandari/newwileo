...
define( 'WPF_VIEWS_EDIT_ENTRY_VERSION',  '1.9.9.2' );
...
function wpf_views_edit_entry_include_files() {
	...
	require_once WPF_VIEWS_EDIT_ENTRY_DIR_URL . '/inc/class-wpf-views-user-registration-integration.php';

	require_once WPF_VIEWS_EDIT_ENTRY_DIR_URL . '/inc/class-wpf-views-edit-entry-prefill-fields.php';
	// Load all form field files automatically
	foreach ( glob( WPF_VIEWS_EDIT_ENTRY_DIR_URL . '/inc/fields/class-wpf-views-edit-entry-prefill*.php' ) as $field_filename ) {
