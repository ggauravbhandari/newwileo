 ...
 * Text Domain: wpforms-views-datatable
...
define( 'WPFORMS_VIEWS_DATATABLES_VERSION',  '1.4.4' );
define( 'WPFORMS_VIEWS_DATATABLES_PLUGIN_FILE', __FILE__ );


function wpf_views_datatables_load_plugin_textdomain() {
    load_plugin_textdomain( 'wpforms-views-datatable', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'wpf_views_datatables_load_plugin_textdomain' );
