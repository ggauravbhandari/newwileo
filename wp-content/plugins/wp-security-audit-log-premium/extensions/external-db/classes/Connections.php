...
final class WSAL_Ext_Connections {
		...
		?>
            <div id="wsal-connection-wizard" class="hidden">
                <form method="POST">
                    ...
                    <h3 class="step-title"><?php esc_html_e( 'Type', 'wp-security-audit-log' ); ?></h3>
                    ...
                    <h3 class="step-title"><?php esc_html_e( 'Requirements', 'wp-security-audit-log' ); ?></h3>
                    <div class="step-content">
                    ...
                    <h3 class="step-title"><?php esc_html_e( 'Configure', 'wp-security-audit-log' ); ?></h3>
                    ...
                    <h3 class="step-title"><?php esc_html_e( 'Test', 'wp-security-audit-log' ); ?></h3>
                    <div class="step-content">
                    ...
                    <h3 class="step-title"><?php esc_html_e( 'Name', 'wp-security-audit-log' ); ?></h3>
                    <div class="step-content">
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script(
			'jquery-steps',
			$this->wsal->external_db_util->get_base_url() . 'js/dist/jquery.steps.min.js',
	...
	public function test_connection() {
		...
		if ( isset( $connection['type'] ) && 'mysql' === $connection['type'] ) {
			...
			if ( array_key_exists( $connection['type'], $mirror_types ) ) {
				...
				$current_date = WSAL_Utilities_DateTimeFormatter::instance()->getFormattedDateTime( current_time( 'timestamp', true ) );
				$log_message  = '<6>' . $current_date . ' ' . $website . ' Security_Audit_Log:Test message by WP Activity Log plugin';
