...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \WSAL_Vendor\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = \true, bool $restartSyscalls = \true, ?bool $async = \true) : self
    {
