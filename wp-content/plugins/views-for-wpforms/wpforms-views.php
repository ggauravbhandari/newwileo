...
define( 'WPFORMS_VIEWS_VERSION',  '2.0.11' );
...
function wpf_views_load_plugin_textdomain() {
    load_plugin_textdomain( 'wpforms-views', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'wpf_views_load_plugin_textdomain' );
...
function wpforms_views_pro_include_files() {
	...
	require_once WPFORMS_VIEWS_DIR_URL . '/inc/admin/class-wpforms-views-duplicate-view.php';
...
function wpforms_views_pro_frontend_scripts() {
	...
	wp_enqueue_style( 'flatpickr', WPFORMS_VIEWS_URL . '/assets/css/flatpickr.min.css' );
	wp_enqueue_style( 'fontawesome', WPFORMS_VIEWS_URL . '/assets/css/font-awesome.css' );
	wp_enqueue_script( 'flatpickr', WPFORMS_VIEWS_URL . '/assets/js/flatpickr.js', array('jquery' ) );
	wp_enqueue_script( 'wpforms-views-front', WPFORMS_VIEWS_URL . '/assets/js/wpforms-views-display.js', array('jquery','flatpickr' ) );
}
