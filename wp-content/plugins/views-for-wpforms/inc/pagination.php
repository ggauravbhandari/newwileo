...
class WPForms_View_Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1) {
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>" . __( 'Previous', 'wpforms-views' ) . "</a></li>";
		}else{
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>" . __( 'Next', 'wpforms-views' ) . "</a></li>";
		else
