<?php
class WPForms_Views_Duplicate_View {


	function __construct() {
		add_action( 'admin_action_duplicate_view', array( $this, 'duplicate_view' ) );
 ...
 */
	function duplicate_link( $actions, $post ) {
		...
		if ( get_post_type( $post ) !== 'wpforms-views' ) {
			return $actions;
		}
...
function admin_notice() {
    ...
    if ( isset( $_GET[ 'saved' ] ) && 'post_duplication_created' == $_GET[ 'saved' ] ) {
		 ...
		 echo '<div class="notice notice-success is-dismissible"><p>View copy created.</p></div>';
...
new WPForms_Views_Duplicate_View();
