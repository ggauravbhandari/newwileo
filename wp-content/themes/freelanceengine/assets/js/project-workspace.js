                ...
                this.docs_uploader = new AE.Views.File_Uploader({
                    ...
                    success: function (res) {
                        ...
                        if (res.success) {
                            ...
                            console.log('line 144. upload successful and append to list files.');
                            var template = '<li class="attachment-' + res.attachment.ID + ' att-workspace-item-js">' +
                                '<p>' + res.attachment.post_title + '<span>' +
                                '<a href="' + res.attachment.guid + '" target="_blank" download><i class="fa fa-cloud-download" aria-hidden="true"></i></a>' +
                ...
                if (result.success) {
                    if (result.data.isAttach == '' && result.data.isAttach == '' && result.data.template_file == "") {
                        if (result.data.changed_milestone_id != '') {
                            view.listMessages.$el.append('<li class="milestone-item-noti milestone-item-noti-line330">' + result.data.comment_content + '</li>');
                        } else {
                    ...
                    if (result.data.isAttach != undefined && result.data.isAttach == 'isAttach') {
                        ...
                        console.log('line 338 - append');

                        //$('.upload_file_file_list').append(result.data.template_file); // 1.8.16
                        /*
