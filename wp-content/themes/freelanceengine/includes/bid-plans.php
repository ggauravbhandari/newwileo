...
function fre_button_bid( $project_id ) {
	...
	/* Get project type*/
	$term_obj_name = wp_get_post_terms($project_id, 'project_type',  array("fields" => "all"));
	...
	if ( ! $profile || ! is_numeric( $profile_id ) ) {
		...
		if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == 'time-based'){
			echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color" btnbid1 data-project-id="' . $project_id . '">' . __( 'Apply', ET_DOMAIN ) . '</a>';
		}else if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == "projects-panels"){
			echo '<a href="#" class="fre-normal-btn " btnbid1 data-project-id="' . $project_id . '">' . __( 'Express my interest ', ET_DOMAIN ) . '</a>';
		}else{
			echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color" btnbid1 data-project-id="' . $project_id . '">' . __( 'Offer', ET_DOMAIN ) . '</a>';
		}
		...
		if ( ae_get_option( 'invited_to_bid' ) && ! fre_check_invited( $user_ID, $project_id ) ) {
			...
			if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == 'time-based'){
				echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color" btnbid2 data-project-id="' . $project_id . '">' . __( 'Apply', ET_DOMAIN ) . '</a>';
			}else if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == "projects-panels"){
				echo '<a href="#" class="fre-normal-btn " btnbid1 data-project-id="' . $project_id . '">' . __( 'Express my interest ', ET_DOMAIN ) . '</a>';
			}else{
				echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color" btnbid2 data-project-id="' . $project_id . '">' . __( 'Offer', ET_DOMAIN ) . '</a>';
			}
		} else {
			// disable option pay to bid
			if ( ! can_user_bid( $user_ID ) ) {
				if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == 'time-based'){
					echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color"  btnbid3 data-project-id="' . $project_id . '">' . __( 'Apply', ET_DOMAIN ) . '</a>';
				}else if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == "projects-panels"){
					echo '<a href="#" class="fre-normal-btn " btnbid1 data-project-id="' . $project_id . '">' . __( 'Express my interest ', ET_DOMAIN ) . '</a>';
				}else{
					echo '<a href="#" class="fre-normal-btn purchase-bid-btn primary-bg-color"  btnbid3 data-project-id="' . $project_id . '">' . __( 'Offer', ET_DOMAIN ) . '</a>';
				}
			} else {
				if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == 'time-based'){
					echo '<a href="#" class="fre-normal-btn primary-bg-color btnbid4" btnbid4 data-toggle="modal" data-target="' . $target . '">' . __( 'Apply', ET_DOMAIN ) . '</a>';
				}else if(!empty($term_obj_name[0]) && $term_obj_name[0]->slug == "projects-panels"){
					echo '<a href="#" class="fre-normal-btn " btnbid1 data-project-id="' . $project_id . '">' . __( 'Express my interest ', ET_DOMAIN ) . '</a>';
				}else{

					echo '<a href="#" class="fre-normal-btn primary-bg-color btnbid4" btnbid4 data-toggle="modal" data-target="' . $target . '">' . __( 'Offer', ET_DOMAIN ) . '</a>';
				}
			}
		}
	}
