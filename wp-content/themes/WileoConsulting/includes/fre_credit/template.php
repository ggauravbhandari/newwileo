...
if( !function_exists('fre_credit_add_profile_tab') ){
    ...
    function fre_credit_add_profile_tab(){ ?>
        <li>
            <a href="<?php echo et_get_page_link( "my-reports" ) ?>"><?php _e('My Reports', ET_DOMAIN) ?></a>
        </li>
   <?php }
}
      ...
      $list_credit_pending = get_list_credit_pending($user_ID);
        ...
        <div class="fre-page-wrapper tabs-credits" id="credits">
            <div class="fre-page-title">
                <div class="container">
                    <h2><?php _e('My Reports' , ET_DOMAIN) ?></h2>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="fre-credit-wrap">
                        <div class="fre-tab-content">
                            <div id="fre-credit-transaction" class="fre-panel-tab fre-credit-history-wrapper active">
