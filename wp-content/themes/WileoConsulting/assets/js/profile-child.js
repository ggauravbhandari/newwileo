(function($, Models, Collections, Views) {
     ...
     */
     Views.Profile = Backbone.View.extend({
        el: '.list-profile-wrapper, #profile-settings',
        events: {
            ...
            'click a.portfolio-add-btn': 'openModalAddPortfolio',
     ...
     Views.Modal_Add_Portfolio = Views.Modal_Box.extend({
         ...
         */
         initialize: function() {
            ...
            console.log(author_id);
             $('.portfolio-add-form .fre-form-close').click(function(){
                jQuery('.portfolio-add-form').hide();
                jQuery('.portfolio-add-btn').show();
            });
            $('.portfolio-add-btn').click(function(){
                jQuery(this).hide();
                jQuery('.portfolio-add-form').show();
          //a  $('#modal_add_portfolio').on('shown.bs.modal', function (){
