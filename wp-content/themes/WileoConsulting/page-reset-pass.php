<?php
/** * Template Name: Reset Password Page Template * * This is the template that displays all pages by default. * Please note that this is the WordPress construct of pages and that * other 'pages' on your WordPress site will use a different template. * * @package WordPress * @subpackage FreelanceEngine * @since FreelanceEngine 1.0 * @slug reset-pass */
global $post;
get_header(); ?>
    ...
    <div class="fre-page-section">
        <div class="container">
            <div class="fre-authen-wrapper">
                ...
                <div class="fre-authen-reset-pass"><a href="<?= home_url('login'); ?>" class="back-btn">
                    ...
                    <p><?php _e("Your password should be at least 6 characters long and contain at least 1 number and 1 special characters.", ET_DOMAIN);?></p>
                    <form role="form" id="resetpass_form" class="signin_form">
                        <input type="hidden" id="user_login"
                               name="user_login"
                               value="<?php if (isset($_GET['user_login'])) echo $_GET['user_login'] ?>"/>
                        ...
                        <div class="fre-input-field">
                            ...
                            <input type="password" name="new_password" id="new_password"
                                                            placeholder="<?php _e('New Password', ET_DOMAIN); ?>"></div>
                        <div class="fre-input-field">
                            <label><?php _e('Confirm new password', ET_DOMAIN)?></label>
                            <input type="password" id="re_new_password" name="re_new_password"
                                                            placeholder="<?php _e('Repeat your password', ET_DOMAIN); ?>">
                        </div>
                        <div class="fre-input-field">
                            <button class="fre-submit-btn btn-submit primary-bg-color"><?php _e('Confirm', ET_DOMAIN); ?></button>
                        </div>
                    </form>
                </div>
            </div>
