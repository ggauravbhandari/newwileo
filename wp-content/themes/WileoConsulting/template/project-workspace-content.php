...
$project_type = isset($post_object->current_post->tax_input['project_type'][0]) ? $post_object->current_post->tax_input['project_type'][0]->slug : null;
    ...
    <div class="row">
        <div class="col-md-8">
            <div id="workspace-conversation"
                 class="project-workplace-details workspace-conversation workplace-details tab-pane fade in active" 
                 <?php if ($project_type == 'time-based') {
                        echo 'style="height: inherit;"';
                    }
                ?>>
                <h2 class="workspace-title"><?php ($project_type == 'time-based') ? _e( 'Timesheet', ET_DOMAIN ): _e( 'Conversation', ET_DOMAIN ); ?>
                <?php 
                    if ($project_type == 'time-based') {
			        echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="fre-btn fre-post-project-next-btn primary-bg-color" target="_blank" href="http://wileo.com.au/workspace">Open Timesheet
