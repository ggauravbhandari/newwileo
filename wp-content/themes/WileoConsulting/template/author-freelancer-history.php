...
?>
<?php
global $user_bids,$wp_query, $current_user;
...
?>
<style>
    .profile-freelance-wrap .col-md-4 {
        padding-right: 0;
    }
    .profile-freelance-wrap .col-md-8 {
        padding-left: 0;
    }
</style>
<div class="fre-profile-box workhistory-profile-box" style="padding-left: 30px;">
