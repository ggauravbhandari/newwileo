                        ...
                        <?php if (isset($_GET['msg']) && $_GET['msg'] === 'success') { ?>
                            <div class="forgot-password-success">
                                <svg width="36" height="34" viewBox="0 0 36 34" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 0.5V3.35059L0.0117188 9.2041V33.5H35.9883V9.2041L27 3.34766V0.5H9ZM12 3.5H24V15.0225L18 18.9102L12 15.0225V3.5ZM13.5 6.5V9.5H22.5V6.5H13.5ZM9 6.92773V13.0801L4.26562 10.0127L9 6.92773ZM27 6.92773L31.7344 10.0127L27 13.0801V6.92773ZM13.5 11V14H22.5V11H13.5ZM3.01172 12.7754L18 22.4844L32.9883 12.7754V30.5H3.01172V12.7754Z"
                                          fill="#88C050"/>
                                </svg>
                                <p>
                                    Email sent!
                                    We’ve sent an email to your email address, follow the step to recover your
                                    password and login again.
                                </p>
                                <div class="fre-input-field">
                                    <a class="fre-submit-btn btn-submit  primary-bg-color"
                                       href="<?php echo home_url('login'); ?>"><?php _e('Login', ET_DOMAIN); ?></a>
                                </div>
                            </div>

                        <?php } else { ?>
                        <a href="<?= home_url('login'); ?>" class="back-btn">
                            ...
                            Back</a>
                        <h2><?php _e('Forgot your password?', ET_DOMAIN); ?></h2>
                        <p><?php _e("A link to create a new password will be sent to the email address linked to your account.", ET_DOMAIN); ?></p>
                        <form role="form" id="forgot_form" class="auth-form forgot_form" method="post"
                              action="<?php echo home_url('wp-login.php?action=lostpassword') ?>">
                            <input type="hidden" value="<?php echo home_url('forgot-password?msg=success') ?>"
                                   name="redirect_to"/>
                            <div class="fre-input-field">
                                <label for="username">Email</label>
                                <input type="email" id="user_email" name="user_login" required
                                       placeholder="<?php _e('Enter your email address', ET_DOMAIN); ?>">
                                <!-- <div class="message">This field is required.</div> -->
                            </div>
                            <div class="fre-input-field">
                                <button class="fre-submit-btn btn-submit  primary-bg-color"><?php _e('Reset Password', ET_DOMAIN); ?></button>
                            </div>
                            <?php } ?>
                        </form>
                    </div>
