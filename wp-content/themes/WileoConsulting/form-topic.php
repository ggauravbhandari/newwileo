					...
					<p>
						...
						<!--->
						   <!-->
							...
							<!--<label for="bbp_forum_id"></label>-->
							<?php
								bbp_dropdown( array(
									'show_none' => esc_html__( '&mdash; No Category &mdash;', 'bbpress' ),
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) ) : ?>
						...
						<p>
							...
							<form action="/action_page.php">
                             <input type="checkbox" id="show_pre">
                             <label for="show_pre"> Show Preview</label><br>
