...
if ( $is_edit or ! empty( $educations ) ) {
    ...
    <div class="fre-profile-box education-profile-box">
        <div class="profile-freelance-education">
            <div class="row">
                ...
                <span id="fre-empty-education">
				    <?php if ( $is_edit ) { ?>
                    <div class="col-sm-6 col-xs-12">
                        <div class="freelance-education-add freelance-education-add-cus">
                            <a href="javascript:void(0)"
                               <?php echo !empty($profile_id) ? 'class="profile-show-edit-tab-btn"' : '' ?> data-ctn_hide="fre-empty-education"
                               data-ctn_edit="ctn-edit-education">
                                <i class="fa fa-plus" <?php echo empty($profile_id) ? 'style="color: gray;"' : '' ?> <?php 
                                    if ( empty($profile_id) ) {
