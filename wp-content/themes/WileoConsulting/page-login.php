                    ...
                    <div class="fre-authen-login">
                        <a href="<?= home_url();?>" class="back-btn">
                            <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.6405 3.3905L2.3905 7.6405L2.047 8L2.3905 8.3595L6.6405 12.6095L7.3595 11.8905L3.969 8.5H14V7.5H3.9685L7.3595 4.1095L6.6405 3.3905Z" fill="#88C050"/>
                            </svg>
                            Back</a>
                        <h2><?php _e( 'Login', ET_DOMAIN ) ?></h2>
                        <form role="form" id="signin_form" class="" method="post">
                            <input type="hidden" value="<?php echo $re_url ?>" name="redirect_to"/>
                            <div class="fre-input-field">
                                <label for="username">Email</label>
                                <input type="email" name="user_login" id="username"
                                       placeholder="<?php _e( 'Enter your email address', ET_DOMAIN ) ?>">
                            </div>
                            <div class="fre-input-field">
                                <label for="password">Password</label>
                                <input type="password" name="user_pass" id="password"
                                       placeholder="<?php _e( 'Enter your password', ET_DOMAIN ) ?>">
                            </div>
